...
{
    /// <summary> Honey-Dos Group Account.  </summary>
    public class GroupAccount
    {
        /// <summary> The id of the group that the account belongs too.  </summary>
        public Guid GroupId { get; private set; }
        /// <summary> The id of the account the group contains </summary>
        ...
        /// <summary> Create new group account.  </summary>
